...
{import(
	'Password.Forgot.js',
	[
		'route.user.cms.core.password.forgot.success' => route.get(route.prefix() + '-user-password-forgot-success')
	]
)}
{$request = request()}
<section name="user-password-forgot">
	...
	<div class="user-password-forgot">
    	<form name="user_password_forgot" data-url="{server.url('backend')}User/Password/Forgot/Process/">
